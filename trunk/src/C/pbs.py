...
def log_roll(*args):
  return _pbs.log_roll(*args)
log_roll = _pbs.log_roll

def log_size():
  return _pbs.log_size()
...
def log_remove_old(*args):
  return _pbs.log_remove_old(*args)
log_remove_old = _pbs.log_remove_old
